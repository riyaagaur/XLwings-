...
source_path = '/Users/riyagaur/Downloads/Excel workbooks/newchurn.xlsx'
retention_path = '/Users/riyagaur/Downloads/Excel workbooks/2024.10 RadarFirst - Retention Analysis_v02.xlsx'

# Open the source workbook containing the "New & Churn" data
source_wb = xw.Book(source_path)
# Adjust the sheet name if needed; here we assume it's "New & Churn"
source_sheet = source_wb.sheets['New & Churn']

# Open the retention analysis workbook
retention_wb = xw.Book(retention_path)
# Access the destination sheet; again, ensure the name matches exactly
dest_sheet = retention_wb.sheets['New & Churn']
...
print(f"Copying data from {source_path} sheet 'New & Churn' at range {address}")
...
print("Data successfully copied from 'newchurn.xlsx' to the 'New & Churn' sheet in the retention analysis workbook.")
